...
from data.gemini_raw_data import gemini_prompt, gemini_week_prompt
...
class GeminiClient:
    ...
    def ask_daily(self, sector, data):
    ...
    def ask_week(self, sector, data):
        prompt = gemini_week_prompt(sector, data)
